...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        OrderApiClientIntegrationTest.class
})
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
@Ignore
public class OrderApiIntegrationTestSuite {
    ...
    public static SpringContextRule getComponentRule() {
        if (COMPONENT_TEST_RULE == null) {
            ...
            COMPONENT_TEST_RULE.addXmlConfiguration("order-component-test-space.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("order-component-test-export.xml");
            ...
            COMPONENT_TEST_RULE.addBean(MarketApiClient.DEFAULT_API_BEAN_NAME,MARKET_API_CLIENT);
        }
    ...
    public static SpringContextRule getApiRule() {
        if (API_TEST_RULE == null) {
            ...
            API_TEST_RULE.addXmlConfiguration("order-component-test-import.xml");
