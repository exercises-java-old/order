...
public class OrderComponentServiceIntegrationTestSuite {
    ...
    public static SpringContextRule getExportContext() {
        if (EXPORT_TEST_RULE == null) {
            EXPORT_TEST_RULE = new SpringContextRule()
                    .addXmlConfiguration("order-component-dao.xml")
                    .addXmlConfiguration("order-component-service.xml")
                    .addXmlConfiguration("order-component-test-export.xml")
                    .addXmlConfiguration("order-component-test-space.xml")
    ...
    public static synchronized SpringContextRule getImportContext() {
        if (IMPORT_TEST_RULE == null) {
            ...
            IMPORT_TEST_RULE.addXmlConfiguration("order-component-client.xml");
            IMPORT_TEST_RULE.addXmlConfiguration("order-component-test-import.xml");
