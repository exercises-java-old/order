...
@SpaceClass
public class OrderTransactionEntity extends IdEntity<String> {
    ...
    private OrderTransactionEntity(Builder builder) {
    ...
    public static class Builder extends AbstractEntityBuilder<OrderTransactionEntity> {
        ...
        public OrderTransactionEntity.Builder withId(String id) {
            this.id = id;
            return this;
        }

        public OrderTransactionEntity.Builder withArrangementId(String arrangementId) {
            this.arrangementId = arrangementId;
            return this;
        }

        public OrderTransactionEntity.Builder withBatchId(String batchId) {
            this.batchId = batchId;
            return this;
        }

        public OrderTransactionEntity.Builder withInsertionTimestamp(Instant insertionTimestamp) {
            this.insertionTimestamp = insertionTimestamp;
            return this;
        }

        public OrderTransactionEntity.Builder withAddress(String address) {
            this.address = address;
            return this;
        }

        public OrderTransactionEntity.Builder withPhase(Phase phase) {
            this.phase = phase;
            return this;
        }

        public OrderTransactionEntity.Builder withAmount(Money amount) {
            this.amount = amount;
            return this;
        }

        @Override
        public OrderTransactionEntity build() {
            return new OrderTransactionEntity(this);
        }
    }
}
